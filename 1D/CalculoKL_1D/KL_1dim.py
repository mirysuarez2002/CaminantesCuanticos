...
archivos1 = [("hadamard_teorico_2.csv", "hadamard_IBM_fez_2.csv", 2),
            ("hadamard_teorico_6.csv", "hadamard_IBM_fez_6.csv", 6),
            ("hadamard_teorico_10.csv", "hadamard_IBM_fez_10.csv",10)]

archivos2 = [("hadamard_teorico_2.csv", "hadamard_IBM_kingston_2.csv", 2),
            ("hadamard_teorico_6.csv", "hadamard_IBM_kingston_6.csv", 6),
            ("hadamard_teorico_10.csv", "hadamard_IBM_kingston_10.csv",10)]

archivos3 = [("hadamard_teorico_2.csv", "hadamard_IBM_marrakesh_2.csv", 2),
            ("hadamard_teorico_6.csv", "hadamard_IBM_marrakesh_6.csv", 6),
            ("hadamard_teorico_10.csv", "hadamard_IBM_marrakesh_10.csv",10)]

archivos4 = [("hadamard_teorico_2.csv", "hadamard_IBM_aachen_2.csv", 2),
            ("hadamard_teorico_6.csv", "hadamard_IBM_aachen_6.csv", 6),
            ("hadamard_teorico_10.csv", "hadamard_IBM_aachen_10.csv",10)]
...
def divergencia(df_teo, df_real):
    # Extraemos la segunda columna de cada archivo (usando el índice 1)
    col_teo = df_teo.iloc[:, 1]
    col_real = df_real.iloc[:, 1]    
...
plt.title('Teórico vs Ordenador Cuántico IBM')
