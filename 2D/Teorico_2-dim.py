...
archivo = "hadamard_teorico_2.csv"
...
qc = QuantumCircuit(q_posicion_1D*2 + 2) 
...
for bit_pos, prob_pos in probs.items(): #Recorremos el lista, mirando cada bit y su probabilidad
    ...
    pos_prob [pos_decimal_horizontal, pos_decimal_vertical] += prob_pos #Sumamos todas las probabilidades de la posición, ignorando el estado moneda
...
#Se definen los valores de la gráfica 3D
...
#La primera vez que lo ejecuto si debo buscar el máximo, para saber cuál es:
#max_z = np.max(z)
